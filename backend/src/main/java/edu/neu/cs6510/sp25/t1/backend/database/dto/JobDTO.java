...
public class JobDTO {
   ...
   *
   * @param jobEntity The Job entity to convert
   * @return The JobDTO
   */
  public static JobDTO fromEntity(JobEntity jobEntity) {
    return new JobDTO(jobEntity.getName(), jobEntity.getImage(), jobEntity.getScript(), jobEntity.isAllowFailure());
  }
